		...
		public:
			...
			*/
			struct Context
			{
				...
				Constructor.
				*/
				inline Context(Directory<Mailbox> *const mailboxes, SpinLock *const sharedWorkQueueSpinLock, FallbackHandlerCollection *const fallbackHandlers, IAllocator *const messageAllocator)
